...
const SUMMARY_MESSAGE = "Too many moves to list or auto-solve. Reduce n to 6 or less.";

app.post("/api/hanoi/solve", (req: Request, res: Response<SolveResponse | ErrorResponse>) => {
